...
str_path = '/home/pi/ProjectFace/database/' + usr_folder_name # it's a string
path_path = os.path.join('/home/pi/ProjectFace/database/', usr_folder_name) # it's a path object
...
while (True):
    ...
    for (x,y,w,h) in faces:
        ...
        if os.path.exists(str_path):
            ...
            #cv2.imwrite(str_final_name, roi_gray)
